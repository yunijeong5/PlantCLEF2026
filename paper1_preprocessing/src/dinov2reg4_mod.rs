//! Implementation of the DINOv2 model with 4 registers
//!
...
//use candle_datasets::lib_cuda_rs::cuda_attn_generic;
...
impl Module for Attention {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
        ...
        let use_cuda_attn = false;
        let use_f16_attn = false;
        ...
        let attn_output = if use_flash_attn {
            ...
            use lib_cuda_rs::cuda_attn_generic; // Charger la crate uniquement si utilisée
...
impl FeaturesModule for DinoVisionTransformer {
...
impl HeadModule for DinoVisionTransformer {
